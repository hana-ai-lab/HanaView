...
class MarketDataFetcher:
    ...
    def generate_news_analysis(self):
        ...
        3.  各トピックについて、以下の情報を個別のフィールドに分けてください。
            - **fact**: ニュースの客観的な事実（例：「NVIDIAが新製品を発表」）。
            - **interpretation**: その事実が市場でどのように受け止められているかの解釈（例：「AIの性能向上期待から買いが先行」）。
            - **impact**: 今後の市場に与えうる短期的な影響（例：「他の半導体株にも買いが波及する可能性」）。
            - **url**: 分析の基となった記事のURL。
        ...
        {{
          ...
          "topics": [
            {{
              ...
              "fact": "トピック1の客観的な事実",
              "interpretation": "トピック1の事実に対する市場の解釈",
              "impact": "トピック1が市場に与える短期的な影響",
              "url": "基となった記事のURL"
            }},
            {{
              "title": "トピック2のタイトル（20文字以内）",
              "fact": "トピック2の客観的な事実",
              "interpretation": "トピック2の事実に対する市場の解釈",
              "impact": "トピック2が市場に与える短期的な影響",
              "url": "基となった記事のURL"
            }},
            {{
              "title": "トピック3のタイトル（20文字以内）",
              "fact": "トピック3の客観的な事実",
              "interpretation": "トピック3の事実に対する市場の解釈",
              "impact": "トピック3が市場に与える短期的な影響",
              "url": "基となった記事のURL"
            }}
          ]
        }}
